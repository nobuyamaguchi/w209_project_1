...
d3.csv("data/Activities.csv",
  ...
  function (err, data) {
    ...
    // csData.dimPace = csData.dimension(function (d) {
    //   // for pace create dimension from 3:00 to 7:00 by 30 sec
    //   var start = dateFmt2("3:00");
    //   var end = dateFmt2("7:00");
    //   var thresholds = d3.timeSeconds(start,end, 30);
    //
    //   var bin = thresholds[0];
    //   for(var i=0;i<thresholds.length;i++){
    //     if (d["Avg Pace"]>thresholds[i]){
    //       bin = thresholds[i]
    //     }
    //   }
    //   return bin; });
    ...
    // csData.distanceBin = csData.dimDistance.group(function (d) { console.log(d); return Math.floor(d) });
    // function binner(val){
    //   var start = dateFmt2("3:00");
    //   var end = dateFmt2("7:00");
    //
    ...
    //
    // }
    // csData.paceBin = csData.dimPace.group(binner);
    // csData.paceBin = csData.dimPace.group();
    ...
    // barChartPace.onMouseOver(function (d) {
    //
    //   csData.dimPace.filter(d.key);
    //
    //   // show tooltip & add value inside tooltip
    //   tooltips.transition()
    //             .duration(200)
    ...
    //             .style("border-radius", "8px")
    //             .style("pointer-events", "none");
    //   tooltips.html("You select "+d3.timeFormat("%M:%S")(d.key) + " min/km<br/>"+ d.value + " times" )
    //       .style("left", (d3.event.pageX+5) + "px")
    //       .style("top", (d3.event.pageY - 28) + "px");
    //
    //   d3.select(this)
